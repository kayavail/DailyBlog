...
app.get("/", function (req, res) {
  res.render("home", {homestart: homeStartingContent, x: blog});
});
...
app.get("/post/:route/", function(req, res){
  // var check = blog.some(x => x.title === req.params.route)
  // if (check)
  //   {
  //   console.log("matched");
  // }
  // else {
  //   console.log("not matched" + " " +req.params.route);
  // }
  // })
...
if(reqFile === lowerTitle)
  {
    res.render("post" , {title : x.title, content: x.body, added: x.dateAdded});
}
})
})
